...
export function AvatarUploader({
  ...
  return (
    <div className="flex items-center gap-4">
      <span className="relative grid h-16 w-16 flex-none place-items-center overflow-hidden rounded-full bg-blue-tint font-sora text-2xl font-bold text-blue-deep">
        {url ? (
